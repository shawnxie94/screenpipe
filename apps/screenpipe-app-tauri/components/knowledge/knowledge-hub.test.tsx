...
vi.mock("@/components/settings/knowledge-section", () => ({
  KnowledgeSection: () => <div data-testid="knowledge-section-stub">画布内容</div>,
}));
...
describe("KnowledgeHub", () => {
  ...
  it("keeps knowledge, work units, and canvas as the only knowledge-base tabs", async () => {
    ...
    expect(await screen.findByTestId("knowledge-section-stub")).toBeTruthy();
  });
