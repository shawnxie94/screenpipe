...
// 知迹 product display constants (PRD R11). This module only centralizes
...
export const PRODUCT_DESCRIPTION = "本地优先的个人工作知识库";
export const PRODUCT_TAGLINE = "把工作经历，沉淀为自己的知识。";
