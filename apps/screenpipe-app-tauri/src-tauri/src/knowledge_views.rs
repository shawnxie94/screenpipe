...
//! Tauri adapter for portable Live Views rendered inside Knowledge.
//!
//! The shared engine owns `live-view-template.v1`, validation, persistence,
//! and pipe target compilation. This module keeps the existing Knowledge-facing
...
const KNOWLEDGE_VIEW_CANVAS_SCHEMA: &str = "live-view-canvas.v1";
...
pub enum KnowledgeViewDisplayMode {
    #[default]
    Dashboard,
    Canvas,
}
...
pub struct KnowledgeViewCanvasViewport {
    pub x: f64,
    pub y: f64,
    pub zoom: f64,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewCanvasBlock {
    pub slot_id: String,
    pub x: f64,
    pub y: f64,
    pub width: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewCanvasNote {
    pub id: String,
    pub text: String,
    pub x: f64,
    pub y: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewCanvasArrow {
    pub id: String,
    pub from_id: String,
    pub to_id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewCanvasPoint {
    pub x: f64,
    pub y: f64,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewCanvasStroke {
    pub id: String,
    pub points: Vec<KnowledgeViewCanvasPoint>,
}

#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewCanvasDocument {
    pub schema: String,
    pub view_id: String,
    pub revision: u64,
    pub mode: KnowledgeViewDisplayMode,
    pub viewport: KnowledgeViewCanvasViewport,
    pub blocks: Vec<KnowledgeViewCanvasBlock>,
    pub notes: Vec<KnowledgeViewCanvasNote>,
    pub arrows: Vec<KnowledgeViewCanvasArrow>,
    pub strokes: Vec<KnowledgeViewCanvasStroke>,
    pub updated_at: String,
}

#[derive(Debug, Clone, Serialize, Deserialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub struct SaveKnowledgeViewCanvasRequest {
    pub view_id: String,
...
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewBinding {
    pub pipe_name: String,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, specta::Type, PartialEq, Eq, Default)]
pub enum KnowledgeViewTimeRange {
    #[default]
    #[serde(rename = "today")]
    Today,
    #[serde(rename = "24h")]
...
impl From<KnowledgeViewTimeRange> for LiveViewTimeRange {
    fn from(range: KnowledgeViewTimeRange) -> Self {
        match range {
            KnowledgeViewTimeRange::Today => Self::Today,
            KnowledgeViewTimeRange::Last24Hours => Self::Last24Hours,
            KnowledgeViewTimeRange::Last7Days => Self::Last7Days,
            KnowledgeViewTimeRange::Last30Days => Self::Last30Days,
        }
    }
}

impl From<LiveViewTimeRange> for KnowledgeViewTimeRange {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
#[serde(tag = "type")]
pub enum KnowledgeViewPeriodPolicy {
    #[serde(rename = "fixed.v1")]
    FixedV1 { value: KnowledgeViewTimeRange },
    #[serde(rename = "selectable.v1")]
    SelectableV1 { values: Vec<KnowledgeViewTimeRange> },
}

impl Default for KnowledgeViewPeriodPolicy {
    fn default() -> Self {
        Self::SelectableV1 {
            values: vec![
                KnowledgeViewTimeRange::Today,
                KnowledgeViewTimeRange::Last24Hours,
                KnowledgeViewTimeRange::Last7Days,
                KnowledgeViewTimeRange::Last30Days,
            ],
        }
    }
}

impl From<KnowledgeViewPeriodPolicy> for LiveViewPeriodPolicy {
    fn from(policy: KnowledgeViewPeriodPolicy) -> Self {
        match policy {
            KnowledgeViewPeriodPolicy::FixedV1 { value } => Self::FixedV1 {
                value: value.into(),
            },
            KnowledgeViewPeriodPolicy::SelectableV1 { values } => Self::SelectableV1 {
...
impl From<LiveViewPeriodPolicy> for KnowledgeViewPeriodPolicy {
...
impl From<KnowledgeViewBinding> for LiveViewSource {
    fn from(binding: KnowledgeViewBinding) -> Self {
        Self::pipe(binding.pipe_name)
    }
}

impl From<LiveViewSource> for KnowledgeViewBinding {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
pub enum KnowledgeViewComponent {
...
impl From<KnowledgeViewComponent> for LiveViewBlockKind {
    fn from(component: KnowledgeViewComponent) -> Self {
        match component {
            KnowledgeViewComponent::MetricV1 => Self::MetricV1,
            KnowledgeViewComponent::ListV1 => Self::ListV1,
            KnowledgeViewComponent::BarChartV1 => Self::BarChartV1,
            KnowledgeViewComponent::LineChartV1 => Self::LineChartV1,
            KnowledgeViewComponent::TableV1 => Self::TableV1,
            KnowledgeViewComponent::TimelineV1 => Self::TimelineV1,
            KnowledgeViewComponent::MarkdownV1 => Self::MarkdownV1,
        }
    }
}

impl From<LiveViewBlockKind> for KnowledgeViewComponent {
...
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewEvidenceRef {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewValue {
    pub payload: Value,
    pub evidence: Vec<KnowledgeViewEvidenceRef>,
...
impl From<StructuredOutputValue> for KnowledgeViewValue {
    fn from(value: StructuredOutputValue) -> Self {
        Self {
            ...
            evidence: value
                .evidence
                .into_iter()
                .map(|reference| KnowledgeViewEvidenceRef {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum KnowledgeViewFeedbackRating {
    Up,
    Down,
}

impl From<OutputFeedbackRating> for KnowledgeViewFeedbackRating {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewFeedback {
    pub rating: KnowledgeViewFeedbackRating,
    pub artifact_output_id: i64,
    pub artifact_version: i64,
...
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewFeedbackSummary {
    pub up_count: usize,
    pub down_count: usize,
    pub current: Option<KnowledgeViewFeedback>,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum KnowledgeViewItemDisposition {
    Active,
    Resolved,
    Snoozed,
    Dismissed,
...
impl From<OutputItemDisposition> for KnowledgeViewItemDisposition {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewItemState {
    pub item_id: String,
    pub disposition: KnowledgeViewItemDisposition,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq, Default)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewItemActionSummary {
    pub items: Vec<KnowledgeViewItemState>,
}

impl From<OutputItemActionSummary> for KnowledgeViewItemActionSummary {
    fn from(summary: OutputItemActionSummary) -> Self {
        Self {
            items: summary
                .items
                .into_iter()
                .map(|state| KnowledgeViewItemState {
...
impl From<OutputFeedbackSummary> for KnowledgeViewFeedbackSummary {
    fn from(summary: OutputFeedbackSummary) -> Self {
        Self {
            up_count: summary.up_count,
            down_count: summary.down_count,
            current: summary.current.map(|feedback| KnowledgeViewFeedback {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewSlot {
    pub id: String,
    pub title: String,
    pub component: KnowledgeViewComponent,
    pub width: u8,
    pub order: u16,
    pub intent: Option<String>,
    pub binding: Option<KnowledgeViewBinding>,
    pub value: Option<KnowledgeViewValue>,
    pub feedback: KnowledgeViewFeedbackSummary,
    pub item_actions: KnowledgeViewItemActionSummary,
}

impl From<LiveViewBlock> for KnowledgeViewSlot {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewDefinition {
    pub id: String,
    pub title: String,
    pub revision: u64,
    pub time_range: KnowledgeViewTimeRange,
    pub period_policy: KnowledgeViewPeriodPolicy,
    pub slots: Vec<KnowledgeViewSlot>,
    pub created_at: String,
    pub updated_at: String,
}

impl From<LiveView> for KnowledgeViewDefinition {
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewSlotInput {
    pub id: String,
    pub title: String,
    pub component: KnowledgeViewComponent,
    pub width: u8,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewTemplatePipe {
    pub name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub struct KnowledgeViewTemplateKit {
    pub id: String,
    pub title: String,
    ...
    pub time_range: KnowledgeViewTimeRange,
    pub period_policy: KnowledgeViewPeriodPolicy,
    pub pipes: Vec<KnowledgeViewTemplatePipe>,
    pub slots: Vec<KnowledgeViewSlotInput>,
}

impl From<LiveViewKit> for KnowledgeViewTemplateKit {
    fn from(kit: LiveViewKit) -> Self {
        Self {
            ...
            pipes: kit
                .pipes
                .into_iter()
                .map(|pipe| KnowledgeViewTemplatePipe {
                    name: pipe.name,
            ...
            slots: kit
                ...
                .blocks
                .into_iter()
                .map(|block| KnowledgeViewSlotInput {
                    id: block.id,
                    title: block.title,
                    component: block.kind.into(),
                    width: block.width,
...
impl From<KnowledgeViewSlotInput> for LiveViewTemplateBlock {
    fn from(slot: KnowledgeViewSlotInput) -> Self {
        Self {
            id: slot.id,
            title: slot.title,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub struct SaveKnowledgeViewRequest {
    pub id: String,
    pub title: String,
    pub expected_revision: Option<u64>,
    pub time_range: KnowledgeViewTimeRange,
...
#[derive(Debug, Clone, Serialize, Deserialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub struct InstallKnowledgeViewTemplateKitRequest {
    pub kit_id: String,
    pub target_view_id: String,
    pub expected_revision: Option<u64>,
}

impl From<SaveKnowledgeViewRequest> for SaveLiveViewRequest {
    fn from(request: SaveKnowledgeViewRequest) -> Self {
        Self {
            id: request.id,
            title: request.title,
...
fn validate_canvas_request(
    request: &SaveKnowledgeViewCanvasRequest,
...
fn save_canvas_document(
    ...
    let document = KnowledgeViewCanvasDocument {
        schema: KNOWLEDGE_VIEW_CANVAS_SCHEMA.to_string(),
...
#[tauri::command]
#[specta::specta]
pub async fn load_knowledge_view_canvas(
    app: tauri::AppHandle,
    view_id: String,
) -> Result<Option<KnowledgeViewCanvasDocument>, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn save_knowledge_view_canvas(
    app: tauri::AppHandle,
    request: SaveKnowledgeViewCanvasRequest,
) -> Result<KnowledgeViewCanvasDocument, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn list_knowledge_view_template_kits() -> Result<Vec<KnowledgeViewTemplateKit>, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn install_knowledge_view_template_kit(
    app: tauri::AppHandle,
    request: InstallKnowledgeViewTemplateKitRequest,
) -> Result<KnowledgeViewDefinition, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn save_knowledge_view(
    app: tauri::AppHandle,
    request: SaveKnowledgeViewRequest,
) -> Result<KnowledgeViewDefinition, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn delete_knowledge_view(app: tauri::AppHandle, id: String) -> Result<(), String> {
    let screenpipe_dir = active_screenpipe_dir(&app)?;
...
mod tests {
    ...
    fn canvas_request(view_id: &str, expected_revision: Option<u64>) -> SaveKnowledgeViewCanvasRequest {
        SaveKnowledgeViewCanvasRequest {
            ...
            expected_revision,
            mode: KnowledgeViewDisplayMode::Canvas,
            viewport: KnowledgeViewCanvasViewport {
                x: 24.0,
                y: 32.0,
                zoom: 1.0,
            },
            blocks: vec![KnowledgeViewCanvasBlock {
            ...
            notes: vec![KnowledgeViewCanvasNote {
            ...
            arrows: vec![KnowledgeViewCanvasArrow {
                id: "arrow-one".to_string(),
                from_id: "block:focus-time".to_string(),
                to_id: "note:note-one".to_string(),
                label: Some("review".to_string()),
            }],
            strokes: vec![KnowledgeViewCanvasStroke {
                id: "stroke-one".to_string(),
                points: vec![
                    KnowledgeViewCanvasPoint { x: 10.0, y: 20.0 },
                    KnowledgeViewCanvasPoint { x: 30.0, y: 40.0 },
                ],
            }],
        }
    }
    ...
    #[test]
    fn knowledge_adapter_preserves_the_portable_block_contract() {
        let input = KnowledgeViewSlotInput {
            id: "focus-time".to_string(),
            title: "Focus time".to_string(),
            component: KnowledgeViewComponent::MetricV1,
            width: 6,
            order: 0,
            intent: Some("Calculate focused work time".to_string()),
            binding: Some(KnowledgeViewBinding {
    ...
    fn canvas_document_round_trips_with_revision_checks() {
        ...
        assert_eq!(first.schema, KNOWLEDGE_VIEW_CANVAS_SCHEMA);
