...
pub struct BrainOfficeConnectionRow {
    pub provider: String,
...
#[derive(Debug, sqlx::FromRow)]
pub struct BrainOfficeObjectRow {
    pub provider: String,
...
impl DatabaseManager {
    ...
    pub async fn brain_office_get_connection(
        &self,
        provider: &str,
    ) -> Result<Option<BrainOfficeConnectionRow>, SqlxError> {
        sqlx::query_as::<_, BrainOfficeConnectionRow>(
    ...
    pub async fn brain_office_list_connections(
        &self,
    ) -> Result<Vec<BrainOfficeConnectionRow>, SqlxError> {
        sqlx::query_as::<_, BrainOfficeConnectionRow>(
            "SELECT provider, account_namespace, cli_path, cli_version, credential_ref, \
             runtime_status, auth_status, sync_status, connection_revision, scope_revision, \
             enabled, auto_sync, last_sync_at, last_success_at, last_error_code, \
    ...
    pub async fn brain_office_ensure_connection(&self, provider: &str) -> Result<(), SqlxError> {
    ...
    pub async fn brain_office_update_connection(
        &self,
        provider: &str,
    ...
    async fn brain_office_ensure_connection_tx(
        &self,
        tx: &mut ImmediateTx,
        provider: &str,
    ) -> Result<(), SqlxError> {
    ...
    pub async fn brain_office_get_scope(
        &self,
        provider: &str,
    ...
    pub async fn brain_office_save_scope(
        &self,
        provider: &str,
        scope_json: &str,
    ) -> Result<i64, SqlxError> {
    ...
    #[allow(clippy::too_many_arguments)]
    pub async fn brain_upsert_office_object(
        &self,
        provider: &str,
    ...
    pub async fn brain_office_get_object(
        &self,
        provider: &str,
        account_namespace: &str,
        object_kind: &str,
        object_id: &str,
    ) -> Result<Option<BrainOfficeObjectRow>, SqlxError> {
        sqlx::query_as::<_, BrainOfficeObjectRow>(
    ...
    pub async fn brain_office_disable_out_of_scope(
        &self,
        provider: &str,
        account_namespace: &str,
    ...
    pub async fn brain_office_imported_object_count(
        &self,
        provider: &str,
    ) -> Result<i64, SqlxError> {
        sqlx::query_scalar(
    ...
    pub async fn brain_office_erase(&self, provider: &str) -> Result<u64, SqlxError> {
        let mut tx = self.begin_immediate_with_retry().await?;
    ...
    pub async fn brain_office_get_cursor(
        &self,
        provider: &str,
        cursor_key: &str,
    ...
    pub async fn brain_office_set_cursor(
        &self,
        provider: &str,
        cursor_key: &str,
        cursor_value: &str,
    ...
    pub async fn brain_office_clear_cursors(&self, provider: &str) -> Result<(), SqlxError> {
        let mut tx = self.begin_immediate_with_retry().await?;
...
/// Explicit update payload for `brain_office_update_connection`.
#[derive(Clone, Debug, Default)]
pub struct BrainOfficeConnectionUpdate {
    pub account_namespace: Option<String>,
    pub cli_path: Option<String>,
    pub cli_version: Option<String>,
    pub credential_ref: Option<String>,
