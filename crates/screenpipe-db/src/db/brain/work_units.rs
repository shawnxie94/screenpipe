...
#[derive(Debug, sqlx::FromRow)]
pub struct BrainWorkUnitRevisionRow {
...
pub struct BrainKnowledgeVersionRow {
    pub id: i64,
...
pub struct ScopeWorkUnits {
    pub units: Vec<(BrainWorkUnitRow, BrainWorkUnitRevisionRow)>,
}
...
impl DatabaseManager {
    ...
    pub async fn brain_save_work_unit(
        &self,
        scope_key: &str,
        task_key: Option<&str>,
    ...
    pub async fn brain_list_scope_work_units(
        &self,
        scope_key: &str,
        limit: u32,
    ) -> Result<ScopeWorkUnits, SqlxError> {
        let units: Vec<BrainWorkUnitRow> = sqlx::query_as(
    ...
    #[allow(clippy::too_many_arguments)]
    pub async fn brain_create_knowledge_candidate(
        &self,
        knowledge_type: &str,
        scope_key: &str,
        title: &str,
    ...
    pub async fn brain_add_knowledge_candidate_version(
        &self,
        knowledge_id: &str,
        title: &str,
        body: &str,
