...
impl DatabaseManager {
    ...
    pub async fn brain_review_transition(
        &self,
        knowledge_id: &str,
        version: i64,
        expected_revision: &str,
        update: BrainReviewUpdate,
    ...
    pub async fn brain_publish_version(
        &self,
        knowledge_id: &str,
        version: i64,
        expected_revision: &str,
    ...
    pub async fn brain_add_rejection_suppression(
        &self,
        scope_key: &str,
        input_hash: &str,
        knowledge_type: &str,
    ...
    pub async fn brain_is_rejected(
        &self,
        scope_key: &str,
        input_hash: &str,
        knowledge_type: &str,
    ...
    pub async fn brain_get_version(
        ...
        knowledge_id: &str,
        version: i64,
    ) -> Result<Option<BrainKnowledgeVersionRow>, SqlxError> {
        sqlx::query_as(
    ...
    pub async fn brain_get_knowledge_item(
        &self,
        knowledge_id: &str,
    ) -> Result<Option<BrainKnowledgeRow>, SqlxError> {
        sqlx::query_as(
    ...
    #[allow(clippy::too_many_arguments)]
    pub async fn brain_insert_feedback(
        &self,
    ...
    pub async fn brain_resolve_feedback(
        &self,
        feedback_id: &str,
        knowledge_id: &str,
    ...
    pub async fn brain_delete_knowledge(&self, knowledge_id: &str) -> Result<(), SqlxError> {
        let mut tx = self.begin_immediate_with_retry().await?;
