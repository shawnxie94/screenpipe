...
impl DatabaseManager {
    ...
    pub async fn knowledge_register_source(
        &self,
        input: &KnowledgeSourceInput,
    ) -> Result<KnowledgeSourceRegistration, SqlxError> {
        ...
        if suppressed {
            tx.commit().await?;
            return Ok(KnowledgeSourceRegistration {
    ...
    pub async fn knowledge_get_source(
        &self,
        source_uid: &str,
    ) -> Result<Option<KnowledgeSourceRow>, SqlxError> {
    ...
    pub async fn knowledge_get_sources(
        &self,
        source_uids: &[String],
    ) -> Result<Vec<KnowledgeSourceRow>, SqlxError> {
        if source_uids.is_empty() {
            return Ok(Vec::new());
        }
        let mut rows = Vec::with_capacity(source_uids.len());
        for uid in source_uids {
            if let Some(row) = self.knowledge_get_source(uid).await? {
                rows.push(row);
            }
        }
        Ok(rows)
    ...
    pub async fn knowledge_source_text(
        &self,
        source_uid: &str,
        revision: &str,
    ...
    pub async fn knowledge_ensure_archived_excerpt(
        &self,
        source_uid: &str,
        revision: &str,
        excerpt: &str,
    ...
    pub async fn knowledge_set_source_state(
        &self,
        source_uids: &[String],
        state: &str,
    ...
    pub async fn knowledge_set_source_media(
        &self,
        source_uids: &[String],
    ...
    pub async fn knowledge_delete_source(
        &self,
        source_uid: &str,
        add_tombstone: bool,
    ) -> Result<(), SqlxError> {
    ...
    pub async fn knowledge_register_dependency(
        &self,
        consumer_kind: &str,
        consumer_id: &str,
    ...
    pub async fn knowledge_consumers_of_sources(
        &self,
        source_uids: &[String],
    ...
    pub async fn knowledge_sources_of_consumer(
        &self,
        consumer_kind: &str,
        consumer_id: &str,
    ...
    pub async fn knowledge_source_uids_for_locator(
        &self,
        locator_table: &str,
        locator_id: i64,
    ...
    pub async fn knowledge_source_uids_captured_between(
        &self,
        kinds: &[&str],
    ...
    pub async fn knowledge_split_published_protected(
        &self,
        source_uids: &[String],
    ...
    pub async fn knowledge_delete_consumer_dependencies(
        &self,
        consumer_kind: &str,
        consumer_id: &str,
    ) -> Result<(), SqlxError> {
