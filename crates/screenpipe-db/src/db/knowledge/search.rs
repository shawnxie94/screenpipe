...
pub struct KnowledgeSearchDocInput {
    pub doc_id: String,
    pub kind: String,
    pub ref_uid: String,
    pub ref_revision: String,
...
impl DatabaseManager {
    ...
    pub async fn knowledge_search_upsert_doc(
        &self,
        input: &KnowledgeSearchDocInput,
    ) -> Result<(), SqlxError> {
    ...
    pub async fn knowledge_search_topk(
        &self,
        match_expr: &str,
        kinds: &[&str],
        k: u32,
    ) -> Result<Vec<KnowledgeSearchHit>, SqlxError> {
    ...
    pub async fn knowledge_search_rebuild(&self, limit: u32) -> Result<u64, SqlxError> {
        ...
        for (uid, kind, title, url, revision, excerpt) in office_rows {
            ...
            self.knowledge_search_upsert_doc(&KnowledgeSearchDocInput {
